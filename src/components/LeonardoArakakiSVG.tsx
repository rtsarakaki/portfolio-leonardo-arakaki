    ...
    <div className={`w-[70%] md:w-[85%] lg:w-[100%] ${className}`}>
      ...
      >
        ...
        <g stroke="#8B4513" strokeWidth="8" fill="none" strokeLinecap="round" strokeLinejoin="round">
          ...
          {/* R - traços com pincel */}
          <path d="M 240 25 Q 238 23 240 25 L 240 70 Q 238 68 240 70 M 240 25 Q 242 23 240 25 L 260 25 Q 262 23 260 25 L 260 45 Q 262 43 260 45 L 240 45 Q 238 43 240 45 L 260 70 Q 262 68 260 70"/>
